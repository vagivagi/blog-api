package org.vagivagi.blog.api.entry.criteria;
...
public class SearchCriteria {
  ...
  public ClauseAndParams toWhereClause() {
    ...
    if (!StringUtils.isEmpty(this.keyword)) {
      params.put(i.toString(), "%" + this.keyword + "%");
      clause.put(i.toString(), "AND e.content LIKE :" + i);
      i.incrementAndGet();
    }
    if (this.createdBy != null) {
      params.put(i.toString(), this.createdBy.getValue());
      clause.put(i.toString(), "AND e.created_by = :" + i);
      i.incrementAndGet();
    }
    if (this.lastModifiedBy != null) {
      params.put(i.toString(), this.lastModifiedBy.getValue());
      clause.put(i.toString(), "AND e.last_modified_by = :" + i);
      i.incrementAndGet();
    }
    if (this.tag != null) {
      params.put(i.toString(), this.tag.getValue());
      clause.put(i.toString(), "AND et.tag_name = :" + i);
      i.incrementAndGet();
    }
    if (this.categoryOrders != null) {
      this.categoryOrders.getValue().forEach(c -> {
        int categoryOrder = c.getCategoryOrder();
        String categoryNameKey = i.toString();
        String categoryOrderKey = String.valueOf(i.incrementAndGet());
  ...
  public static class SearchCriteriaBuilder {
    ...
    public SearchCriteria build() {
      return new SearchCriteria(excludeContent, createdBy, lastModifiedBy, tag, categoryOrders,
          keyword);
    }
    ...
    public String toString() {
      return "SearchCriteria.SearchCriteriaBuilder(excludeContent=" + this.excludeContent
          + ", createdBy=" + this.createdBy + ", lastModifiedBy=" + this.lastModifiedBy + ", tag="
          + this.tag + ", categoryOrders=" + this.categoryOrders + ", keyword=" + this.keyword
          + ")";
    }
  }
}
