...
public class EntryFetcherTest {
    ...
    public void setup() throws Exception {
        ...
        this.gitHubClient =
                new GitHubClient("http://localhost:" + port, WebClient.builder(), new AccessToken("dummy"));
    ...
    public void fetch() throws Exception {
        Buffer contentResponse = new Buffer()
                .readFrom(new ClassPathResource("sample-content-response.json").getInputStream());
        Buffer commitsResponse = new Buffer()
                .readFrom(new ClassPathResource("sample-commits-response.json").getInputStream());
        ...
        StepVerifier.create(entry) //
                .assertNext(e -> {
                    ...
                    assertThat(e.getContent()).isEqualTo(new Content("This is my first blog post!"));
                    assertThat(e.getCreated()).isNotNull();
                    assertThat(e.getCreated().getName()).isEqualTo(new Name("Toshiaki Maki"));
                    assertThat(e.getCreated().getDate())
                            .isEqualTo(new EventTime(OffsetDateTime.parse("2015-12-28T17:16:23Z")));
                    assertThat(e.getUpdated()).isNotNull();
                    assertThat(e.getUpdated().getName()).isEqualTo(new Name("Toshiaki Maki"));
                    assertThat(e.getUpdated().getDate())
                            .isEqualTo(new EventTime(OffsetDateTime.parse("2018-01-14T08:09:06Z")));
